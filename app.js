...
const upsertURL =
  ...
  "http://raceday-staging.sppo:30001/teams/createEvent";
        ...
        eachMessage: async ({ topic, partition, message }) => {
          ...
          if (Object.keys(payloadRaw).includes("dgemm_tw")) {
            ...
            incomingPayload = {
              ...
              peak_mflops: nvl(payload.dgemm_tw.peak_mflops),
            };
            ...
            incomingPayload = {
              ...
              s1_serial_number:
                payload.sut_dimensions.socket[1].iod.serial_number,
              Gflops: nvl(payload.HPL.Gflops),
              rrrr: nvl(payload.ramki),
            };
            ...
            incomingPayload = {
              ...
              s1_serial_number:
                payload.sut_dimensions.socket[1].iod.serial_number,
              mean: nvl(payload.SPECspeed2006_fp.base.mean),
              "_410_bwaves_.base.iterations0.ratio": nvl(
            ...
            incomingPayload = {
              ...
              s1_serial_number:
                payload.sut_dimensions.socket[1].iod.serial_number,
              mean: nvl(payload.SPECspeed2006_int.base.mean),
              "test_400_perlbench_.base.iterations0.ratio": nvl(
